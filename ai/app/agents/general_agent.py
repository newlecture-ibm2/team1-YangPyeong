...
GENERAL_AGENT_SYSTEM_PROMPT = (
    ...
    "  **🔥 (매우 중요) 단, 하단에 제공된 [참고 자료]를 읽어보고, 사용자의 질문에 답변할 수 있는 내용이 명확히 존재하는 경우에만 거절하지 말고 해당 자료를 바탕으로 답변하세요. 참고 자료에 관련 내용이 없다면 억지로 답변을 지어내지 말고 거절 멘트를 사용하세요.**\n"
...
def get_general_agent():
    ...
    async def agent_node(state):
        ...
        if rag_results:
            ...
            rag_context += "위 참고 자료를 주의 깊게 읽어보고, 사용자의 질문과 명확히 관련이 있는 내용이 있을 경우에만 이를 바탕으로 답변해 주세요. 내용이 없다면 억지로 답변을 만들지 말고 기존 규칙대로 거절해야 합니다."
