...
> **최종 갱신**: 2026-05-12  
> **관련 스펙**: `project-spec.md` COM-004, 4.4절
...
| 4 | **댓글/답변 알림** — 내 게시글에 댓글이 달리면 작성자에게 알림 | `SYSTEM` | 게시글 작성자 | 댓글 등록 API (USR-003) | USR-003 |
| 5 | **AI 추천 결과 완료** — 비동기 AI 추천이 완료되면 요청자에게 알림 | `SYSTEM` | 추천 요청자 | AI 추천 완료 콜백 (FRM-006) | FRM-006 |
