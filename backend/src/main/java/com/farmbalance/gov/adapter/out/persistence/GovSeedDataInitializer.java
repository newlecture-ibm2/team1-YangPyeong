...
public class GovSeedDataInitializer {
    ...
    public void init() {
        try {
            ...
            if (userCount != null && userCount == 31 && orderCount != null && orderCount >= 45) {
            ...
            if (userCount != null && userCount > 0) {
                log.info("[Gov Seed] 불완전 시드 데이터 감지. 정리 후 재삽입합니다.");
                ...
                jdbc.execute("DELETE FROM users WHERE id BETWEEN 9000 AND 9040");
            }
