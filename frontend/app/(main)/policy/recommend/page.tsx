          ...
          <div className={styles.resultContainer}>
            ...
            {data.farmerProfile.farmCount === 0 && (
              <div className={styles.emptyState}>
                <span className={styles.icon}>🌱</span>
                <h3 className={styles.emptyStateTitle}>등록된 농장 정보가 없습니다</h3>
                <p className={styles.emptyStateDesc}>농장 정보를 등록하면 지역, 면적, 토양 정보 등을 바탕으로 더 정확한 정책을 추천받을 수 있습니다.</p>
                <div className={styles.buttonGroup}>
            ...
            {data.farmerProfile.farmCount > 0 && data.farmerProfile.crops.length === 0 && (
              <div className={styles.emptyState}>
                <span className={styles.icon}>🌾</span>
            ...
            {/* 2. 추천 정책 리스트 */}
            {data.farmerProfile.farmCount > 0 && data.recommendedPolicies.length === 0 && (
              <div className={styles.emptyState}>
                <span className={styles.icon}>📭</span>
